...
ALLOWED_HOSTS = ['*'] # Railway will provide a random URL; you can restrict this later
...
WSGI_APPLICATION = 'barhop.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        # If DATABASE_URL environment variable isn't found, use your local MySQL
